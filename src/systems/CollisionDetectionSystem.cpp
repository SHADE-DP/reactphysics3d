...
bool CollisionDetectionSystem::testOverlap(CollisionBody* body)
{
...
bool CollisionDetectionSystem::testAABBOverlap(const AABB& aabb) const
{
  return mBroadPhaseSystem.testAABBOverlap(aabb);
}
